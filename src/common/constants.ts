...
export const ERC20_APP_BASE_PATH = '/trade';
...
export const RELAYER_URL = process.env.REACT_APP_RELAYER_URL || 'https://localhost:3000/v3';
export const RELAYER_WS_URL = process.env.REACT_APP_RELAYER_WS_URL || 'wss://localhost:3000/';
...
export const UI_GENERAL_TITLE = 'Ethexium';
